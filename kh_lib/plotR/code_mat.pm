...
sub new{
	...
	# Setting the parameters (common)

	$args{font_size} = $::config_obj->plot_font_size / 100 unless $args{font_size};      # Font size
	...
	if ( defined($self->{selection}) ){                # Code selection
	...
	# Setting the parameters (heatmap)
	...
	# Setting the parameters (bubble plot)
